...
u16 VS_Get_HeadInfo(void)
{
    ...
    {        
        case 0x7665://WAV格式ve
        case 0x5645://WAV格式VE
        case 0X4D54://MIDI格式MT 
		case 0X4154://AAC_ADTS  AT
		case 0X4144://AAC_ADIF      0x41-'A';0x44-'D';
		case 0X4D34://AAC_MP4/M4A   0x4D-'M'; 0x34-'4'
		case 0X4F67://OGG   Og
        case 0X574D://WMA格式WM
		case 0X664C://FLAC格式fL
        {
	        #if !defined  BMW_TEST
			/*HEAD0:16387 Byte/s; */
				printf("Beside MP3>>HEAD0:%d Byte/s; \n",HEAD0);
	        #endif	
        ...
        default://MP3格式,仅做了阶层III的表
        {
			...
			#if !defined  BMW_TEST
			/*MP3>>HEAD0:45668; HEAD1:1;  192 kbps*/  //0x5070:20592; HEAD1:0;  so bitrate[0][5]=40kbps
				printf("MP3>>HEAD0:%d; HEAD1:%d; \n",HEAD0,HEAD1); // 0xB200:45668; HEAD1:1; so  bitrate[1][11]=192kbps
			#endif				
            return bitrate[HEAD1][HEAD0>>12];	//	HEAD0>>12:  get HEAD0's High 4 bits -- the reference bps
        }
    }  
}
//得到平均字节数
